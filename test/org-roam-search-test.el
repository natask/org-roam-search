...
(describe "org-roam-search--query-string-to-sexp"
  ...
  (it "random test"
    (expect (org-roam-search--query-string-to-sexp "dest:dfasdf,where dest:now,better tag:here l:3 title:there what now \"here\"")
            :to-equal
            `(and (destination "dfasdf" "where") (destination "now" "better") (tags "here") (level "3") (titles "there") (all "what") (all "now") (all "here")))))

(describe "org-roam-search--transform-query :transform"
  (let ((sexp (org-roam-search--query-string-to-sexp "title:where tag:love"))
    ...
    (it "handles simple query"
      (expect (org-roam-search--transform-query sexp :transform)
              :to-equal
              res
              )))
  ...
  (let ((sexp1 (org-roam-search--query-string-to-sexp "where love dest:love source:here"))
    ...
    (it "ignores dest: and source:"
      (expect (org-roam-search--transform-query sexp1 :transform)
              :to-equal
              (org-roam-search--transform-query sexp2 :transform)))))

(describe "org-roam-search--transform-query :destination"
  (let ((sexp (org-roam-search--query-string-to-sexp "where dest:hddd,3ds-dfasd3-f"))
        (res '(and (like dest "%%hddd%%") (like dest "%%3ds-dfasd3-f%%"))))
    (it "handles ids"
      (expect (org-roam-search--transform-query sexp :destination)
              :to-equal
              res
              )))
  ...
  (let ((sexp1 (org-roam-search--query-string-to-sexp "where source:best,here tag:love dest:hddd,3ds-dfasd3-f"))
    ...
    (it "ignores all but dest: type search"
      (expect (org-roam-search--transform-query sexp1 :destination)
              :to-equal
              (org-roam-search--transform-query sexp2 :destination)
              )))
...
(describe "org-roam-search--transform-query :source"
  ...
  (let ((sexp1 (org-roam-search--query-string-to-sexp "where source:best,here tag:love dest:hddd,3ds-dfasd3-f"))
    ...
    (it "ignores all but source: type search"
      (expect (org-roam-search--transform-query sexp1 :source)
              :to-equal
              (org-roam-search--transform-query sexp2 :source)
              )))
